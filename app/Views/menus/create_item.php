                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="icon" name="icon"
                                 value="<?= old('icon', 'fas fa-angle-right') ?>" placeholder="e.g., fas fa-home"
                                 required>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <small class="form-text text-muted">
                                 Relative URL without base path. Example: "accounts", "reports/balance-sheet"
                              </small>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="permission" name="permission"
                                 value="<?= old('permission') ?>" placeholder="e.g., accounts.view" required>
                              <small class="form-text text-muted">
                                 Must match Shield permission. Example: "accounts.view", "reports.view"
                              </small>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" id="menu_group_id" name="menu_group_id" required>
                                 ...
                                 <option value="<?= $group['id'] ?>"
                                    <?= old('menu_group_id') == $group['id'] ? 'selected' : '' ?>>
                                    <?= $group['name'] ?>
                                 </option>
                                 <?php endforeach; ?>
                              </select>
            ...
            <div class="card card-info">
               ...
               <div class="card-body">
                  ...
                  <ul class="list-unstyled">
                     ...
                     <li><code>accounts.view</code></li>
                     <li><code>accounts.create</code></li>
                     <li><code>transactions.view</code></li>
                     <li><code>reports.view</code></li>
                     <li><code>users.view</code></li>
                     <li><code>menus.view</code></li>
                  </ul>
                  ...
                  <ul class="list-unstyled">
                     ...
                     <li><code>reports/balance-sheet</code></li>
